 ...
 */
function parseXmlStream(createInitialState, onOpenTag, onCloseTag, onText) {
  ...
  var strict = true;
  var xmlns = true;
  var parser = STREAMING_MODE ? undefined : _sax["default"].parser(strict, parserOptions);

  // This `stream` could be `.pipe()`d to:
  // `Readable.from(xml).pipe(parserStream)`
  var parserStream = STREAMING_MODE ? _sax["default"].createStream(strict, parserOptions) : undefined;
