(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TEST_CASES = {}));
	...
	var writeXlsxFile_testCases = {
		...
		'text-rotation': {
			args: () => {
				...
				dataWithTextRotation[0][2] = {
					...dataWithTextRotation[0][2],
					fontFamily: 'Courier New',
					fontSize: 8,
					textRotation: 45
				};
				dataWithTextRotation[0][3] = {
					...dataWithTextRotation[0][3],
					value: 'Married',
					fontWeight: 'bold',
					fontFamily: 'Courier New',
			...
			args: () => {
				...
				const customFeature = {
					files: {
						transform: {
							'[Content_Types].xml': {
								insert: ({ sensitivityLabelId, sensitivityLabelSiteId, sensitivityLabelAssignmentMethod, sensitivityLabelContentBits }) => {
						...
						write: {
							files: ({ sensitivityLabelId, sensitivityLabelSiteId, sensitivityLabelAssignmentMethod, sensitivityLabelContentBits }) => {
								if (sensitivityLabelId) {
	...
	exports.data = data;
	exports.default = writeXlsxFile_testCases;
