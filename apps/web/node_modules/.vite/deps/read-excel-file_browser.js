import { r as unzip, t as strFromU8$1 } from "./browser-DYITgBpx.js";
...
function parseFilePaths(content, parseXml) {
	...
	function addFilePathForRelation(state, id, type, target) {
		switch (type) {
			...
			case "http://purl.oclc.org/ooxml/officeDocument/relationships/worksheet": state.sheets[id] = getFilePathFromRelationTarget(target);
		}
	}
...
//#endregion
//#region ../../node_modules/read-excel-file/modules/export/readXlsxFileBrowser.js
/**
* Reads an `.xlsx` file.
* @param  {(File|Blob|ArrayBuffer)} input
* @param  {object} [options]
...
function readXlsxFile(input, options) {
	return unpackXlsxFile(input).then(function(contents) {
		return parseSpreadsheetContentsInWorker(createWorkerFunctionInBrowser, parseXml, contents, options);
	});
}
//#endregion
...
//#endregion
//#region ../../node_modules/read-excel-file/modules/parseSheetData/types/additional/Integer.js
...
//#endregion
//#region ../../node_modules/read-excel-file/modules/parseSheetData/types/additional/Email.js
...
//#endregion
//#region ../../node_modules/read-excel-file/modules/parseSheetData/types/additional/URL.js
...
//#endregion
export { Email, Integer, InvalidInputError, InvalidSpreadsheetError, SheetNotFoundError, URL$1 as URL, readXlsxFile as default, parseSheetData, readSheet };
